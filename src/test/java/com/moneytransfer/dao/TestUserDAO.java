...
public class TestUserDAO {
	...
	private static Logger log = LogManager.getLogger(TestUserDAO.class);
	...
	@Test
	public void testGetAllUsers() throws MoneyTransferAPIException {
		List<User> allUsers = h2DaoFactory.getUserDAO().getAllUsers();
		assertTrue(allUsers.size() > 1);
	}

	@Test
	public void testGetUserById() throws MoneyTransferAPIException {
		User u = h2DaoFactory.getUserDAO().getUserById(2L);
		assertTrue(u.getUserName().equals("test1"));
	}

	@Test
	public void testGetNonExistingUserById() throws MoneyTransferAPIException {
		User u = h2DaoFactory.getUserDAO().getUserById(500L);
		assertTrue(u == null);
	}

	@Test
	public void testGetNonExistingUserByName() throws MoneyTransferAPIException {
		User u = h2DaoFactory.getUserDAO().getUserByName("abcdeftg");
		assertTrue(u == null);
	}

	@Test
	public void testCreateUser() throws MoneyTransferAPIException {
	...
	@Test
	public void testUpdateUser() throws MoneyTransferAPIException {
	...
	@Test
	public void testUpdateNonExistingUser() throws MoneyTransferAPIException {
	...
	@Test
	public void testDeleteUser() throws MoneyTransferAPIException {
	...
	@Test
	public void testDeleteNonExistingUser() throws MoneyTransferAPIException {
